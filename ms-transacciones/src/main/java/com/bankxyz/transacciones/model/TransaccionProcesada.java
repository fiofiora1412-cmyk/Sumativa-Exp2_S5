package com.bankxyz.transacciones.model;
...
public class TransaccionProcesada {
    ...
    public TransaccionProcesada(Integer transaccionId, LocalDate fecha, BigDecimal monto,
                                String tipo, Boolean esAnomalia, String motivoAnomalia) {
